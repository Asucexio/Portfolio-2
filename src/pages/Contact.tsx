    ...
    >
            ...
            <div className="flex flex-col gap-8 p-6 bg-[#f0f7f6] rounded-lg">
              <div>
                ...
                <ul className="flex flex-col gap-4">
                  <li className="flex items-center gap-3">
                    ...
                    <a
                      href="mailto:asmamewadmasuofficial@gmail.com"
                      className="text-[#334d49]/80 hover:text-[#5c8a84] transition-colors"
                    >
                      asmamewadmasuofficial@gmail.com
                    </a>
                  </li>
                  <li className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex gap-6">
                  {[
                    {
                      href: "https://github.com/Asucexio",
                      icon: FaGithub,
                    },
                    {
                      href: "https://t.me/Acu_404",
                      icon: FaTelegram,
                    },
                    {
                      href: "https://www.linkedin.com/in/asmamew-admasu",
                      icon: FaLinkedinIn,
                    },
                    { href: "https://x.com/Asucexio", icon: FaTwitter },
                    {
                      href: "https://www.instagram.com/acu_404/",
                      icon: FaInstagram,
                    },
      ...
      <footer className="w-full border-t border-[#d5dddc] py-6 bg-white">
        <p className="text-center text-[#334d49]/60 text-sm">
          © 2025 Asmamew Admasu. All rights reserved.
        </p>
      </footer>
    </div>
  );
