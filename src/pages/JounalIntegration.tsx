...
export const BASE_URL = "https://devjournal-backend-aeh2.onrender.com"; // Replace with your actual backend URL
const MAX_POSTS = 9;
  ...
  return (
    ...
    >
            ...
            filteredPosts?.map((post, index) => {
              ...
              return (
                ...
                >
                  ...
                  <a
                    href={post.post_link || "https://t.me/TerminalThoughts1"}
                    target="_blank"
      ...
      <div className="flex justify-center mt-10">
        <a
          href="https://t.me/TerminalThoughts1"
          target="_blank"
          rel="noopener noreferrer"
